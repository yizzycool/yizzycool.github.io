  ...
  return (
    <button
      ...
      className={cn(
        ...
        'border-neutral-200/80 bg-white/70 text-neutral-800 shadow-neutral-200/40 hover:bg-white dark:border-neutral-400/80 dark:bg-neutral-950/70 dark:text-neutral-200 dark:shadow-black/50 dark:hover:bg-neutral-900',
