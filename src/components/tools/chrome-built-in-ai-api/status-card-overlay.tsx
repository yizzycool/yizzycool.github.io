      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={cn(
              'relative flex max-h-full w-full max-w-md flex-col overflow-y-auto rounded-3xl border border-neutral-200 bg-white p-6 text-center shadow-2xl dark:border-neutral-700 dark:bg-[#111]',
              cardClassName
            )}
          >
            {children}
