    ...
    <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      {mode === 'dashboard' ? (
        <div className="relative w-full max-w-md">
          <span className="absolute inset-y-0 left-0 z-10 flex items-center pl-3.5 text-neutral-400">
            <Search size={18} />
          </span>
          <input
            type="text"
        ...
        <div className="flex items-center gap-2 border border-transparent py-2 text-sm font-semibold text-neutral-500 dark:text-neutral-300">
          ...
          <TooltipRoot>
            ...
            >
              <div className="max-w-xs rounded-xl border border-neutral-700/80 bg-neutral-900 px-3.5 py-2.5 text-xs leading-relaxed text-neutral-100 shadow-xl dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">
