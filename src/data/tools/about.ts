...
export const ToolAbout = {
  ...
  [ToolKeys.picMergeStudio]:
    'PicMerge Studio is a versatile online image editor and photo collage maker designed for combining multiple images into a clean, customizable canvas. Whether you want to create social media photo grids (Instagram 1:1, YouTube 16:9), arrange multi-picture compositions, or perform essential image adjustments like resizing, rotating, tuning opacity, and applying color filters, PicMerge Studio delivers a fast and intuitive workflow. It supports flexible canvas sizing, precision borders, freeform dragging, and structured grid layouts—all processed entirely client-side for maximum speed and privacy, with high-resolution export in PNG, JPEG, or WebP.',
